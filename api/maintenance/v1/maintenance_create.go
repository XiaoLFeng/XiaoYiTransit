...
// CreateMaintenanceReq defines the request for creating a new maintenance record
type CreateMaintenanceReq struct {
	g.Meta             `path:"/maintenance" method:"Post" tags:"维修管理" sm:"创建维修记录" dc:"用于创建新的车辆维修记录"`
...
// CreateMaintenanceRes defines the response for creating a new maintenance record
type CreateMaintenanceRes struct {
