...
// UpdateVehicleReq defines the request for updating a vehicle
type UpdateVehicleReq struct {
	g.Meta             `path:"/vehicle/{vehicleUuid}" method:"Put" tags:"车辆管理" sm:"更新车辆" dc:"用于更新车辆信息"`
...
// UpdateVehicleRes defines the response for updating a vehicle
