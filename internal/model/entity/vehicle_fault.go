...
type VehicleFault struct {
	Id               string      `json:"id"                orm:"id"                description:"故障ID"`                           // 故障ID
	VehicleId        string      `json:"vehicle_id"        orm:"vehicle_id"        description:"车辆ID"`                           // 车辆ID
	ReporterId       string      `json:"reporter_id"       orm:"reporter_id"       description:"报告人ID"`                          // 报告人ID
	...
	MaintenanceId    string      `json:"maintenance_id"    orm:"maintenance_id"    description:"关联的维修记录ID"`                      // 关联的维修记录ID
